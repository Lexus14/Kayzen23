...
JANGAN  DI SEBAR  TANPA PERSETUJUAN AUTHOR !
____________________________________________________________

SAYA SUMPAHIN YANG RECORD GA AKAN SELAMAT !
____________________________________________________________
...
def awalan():
	clear();banner()
	print(f"\n{P}  - selamat datang di tools bang ROLAND yang ganteng dan rupawan ini,silahkan gunakan tools ini dengan bijak !{P}")
	menu = input(f"\n{P}  - 1. login cookies dulu cog. \n  - 2. crack id via file nologin. \n  - 3. cek hasil maling. \n  - pilih nomor nya cog: ")
	if menu in ["01","1"]:
		login()
	elif menu in ["02","2"]:
		Crack_file()
